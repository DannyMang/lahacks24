  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-col items-center justify-center min-h-[100vh] bg-gradient-to-r from-green-100 to-green-300">
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-4xl text-center mt-24"> {/* Adjusted margin top to push below the fixed header */}
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Nature Deck</h1>
          <p className="text-lg md:text-xl mb-8">Explore and engage with the natural world around you effortlessly</p>
          <Link
      ...
      <div>
        <section className="py-20 md:py-32 flex flex-col items-center justify-center min-h-[100vh] bg-gradient-to-r from-green-100 to-green-300" id="about">
          <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">About Us</h2>
            <p className="text-lg md:text-xl mb-8">
              Nature Deck Inc. is a leading provider of innovative products and services for businesses of all sizes. Our team
      ...
      <footer className="text-black py-6">
        <div className="container mx-auto px-4 md:px-6 lg:px-8 flex items-center justify-between">
          <p className="text-sm">© 2024 Nature Deck Inc. All rights reserved.</p>
